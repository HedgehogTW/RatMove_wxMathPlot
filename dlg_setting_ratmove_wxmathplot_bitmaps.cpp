...
void wxC4499InitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/dlg_setting_ratmove_wxmathplot_bitmaps.cpp$D__Project_RatMove_wxMathPlot_dlg_setting_ratmove_wxmathplot_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/dlg_setting_ratmove_wxmathplot_bitmaps.cpp$D__Project_RatMove_wxMathPlot_dlg_setting_ratmove_wxmathplot_bitmaps.xrc"));
}
